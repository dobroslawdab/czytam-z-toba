...
type IconName = 'book' | 'plus' | 'play' | 'edit' | 'trash' | 'arrow-left' | 'settings' | 'home' | 'chart' | 'guide' | 'syllables' | 'compare';
...
export const Icon: React.FC<IconProps> = ({ name, ...props }) => {
  const icons: Record<IconName, React.ReactNode> = {
    ...
    settings: <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.003 1.11-1.226.554-.223 1.19-.223 1.745 0 .55.223 1.02.684 1.11 1.226M10.5 15.75a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0z" />,
    ...
    chart: <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 3m8.5-3l1 3m0 0l.5 1.5m-.5-1.5h-9.5m0 0l-.5 1.5M9 11.25v1.5M12 9v3.75m3-6v6" />,
    guide: <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.105 0 4.059-.712 5.5-1.921L16.5 17.25m-4.5-11.208v11.208" />,
    syllables: <path strokeLinecap="round" strokeLinejoin="round" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />,
    compare: <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" />,
  };
